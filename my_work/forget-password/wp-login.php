		  ...
		  <div class="row">
			  <div class="col-md-6 col-md-offset-3 page_align">
					<div class="page_content">
						<div class="page_header"><h3 class="ttl_head"><b>Congratulations! Your password has been changed.</b></h3></div>
						<div class="col-md-12 col-sm-12 col-xs-12 page_main_cont">
							
							<?php echo '<a href="' . esc_url( wp_login_url() ) . '">' . __( 'Retrun to Login' ) . '</a>';
							?>
					</div>
				</div>
			</div>
...
<form name="resetpassform" id="resetpassform" action="<?php echo esc_url( network_site_url( 'wp-login.php?action=resetpass', 'login_post' ) ); ?>" method="post" autocomplete="off">
	...
	<div class="form-group">
		...
		<input type="password" name="pass1" id="pass1" class="input form-control " size="" value="" autocomplete="off"  /></label>
	</div>
	<div class="form-group">
		<label for="pass2"><?php _e('Confirm new password') ?></label>
		<input type="password" name="pass2" id="pass2" class="input form-control " size="" value="" autocomplete="off" />
	</div>
	...
	<p class="submit"><input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large add_money_btn" value="<?php esc_attr_e('Reset Password'); ?>" /></p>
</form>
<p id="nav">
<a href="<?php echo esc_url( wp_login_url() ); ?>"><?php _e( 'Log in' ); ?></a>
<?php
